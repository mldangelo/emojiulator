    ...
    return (
      ...
      <div className="bg-gray-900 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            {progressPercent < 100 && (
                <div className="mt-2 sm:mt-0 sm:col-span-2 sm:flex sm:items-center sm:space-x-3 sm:space-y-0 space-y-3 py-4">
                    <progress className="w-full" value={progressPercent} max="100" />
                </div>
            )}
            </> )}
            {result?.length > 0 && (<>
      ...
      <div className="mx-auto max-w-7xl overflow-hidden py-20 px-6 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; {new Date().getFullYear()} <a href='https://pandaswipe.club'>PandaSwipe.Club</a>, Inc. All rights reserved.
        </p>
      </div>
    </footer>
